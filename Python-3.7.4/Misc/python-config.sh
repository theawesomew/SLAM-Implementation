...
SYSLIBS="$LIBM $LIBC"
ABIFLAGS="m"
LIBS="-lpython${VERSION}${ABIFLAGS} -lcrypt -ldl  $SYSLIBS"
...
LIBPL=$(echo "$(prefix)/lib/python3.7/config-$(VERSION)$(ABIFLAGS)-aarch64-linux-gnu" | sed "s#$prefix#$prefix_real#")
SO=".cpython-37m-aarch64-linux-gnu.so"
PYTHONFRAMEWORK=""
